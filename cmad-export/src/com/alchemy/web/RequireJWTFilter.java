...
public class RequireJWTFilter implements ContainerRequestFilter {
	...
	public void filter(ContainerRequestContext requestContext) throws IOException {
		...
		System.out.println("RequireJWTFilter filter authorizationHeader :"+authorizationHeader);
		if(authorizationHeader != null && !authorizationHeader.equals("null")) {
			String token = authorizationHeader.substring("Bearer".length()).trim();
			System.out.println("RequireJWTFilter filter rxd TOKEN :"+token);        	
			try {
